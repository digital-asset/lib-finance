...
DAML_MODEL_FILES=("daml-model/src/DA/Finance/Asset.daml"
                  ...
                  "daml-model/src/DA/Finance/Instrument/Equity/ACBRC/Lifecycle.daml"
                  "daml-model/src/DA/Finance/Instrument/Equity/Option/Lifecycle.daml"
                  "daml-model/src/DA/Finance/Instrument/Equity/Stock/Lifecycle.daml"
                  "daml-model/src/DA/Finance/Instrument/Equity/ACBRC.daml"
                  "daml-model/src/DA/Finance/Instrument/Equity/CashDividend.daml"
                  "daml-model/src/DA/Finance/Instrument/Equity/Option.daml"
                  "daml-model/src/DA/Finance/Instrument/Equity/Stock.daml"
                  "daml-model/src/DA/Finance/Instrument/Equity/StockSplit.daml"
                  "daml-model/src/DA/Finance/Instrument/FixedIncome/FixedRateBond/Lifecycle.daml"
                  "daml-model/src/DA/Finance/Instrument/FixedIncome/FixedRateBond.daml"
                  "daml-model/src/DA/Finance/Instrument/FX/Currency.daml"
                  "daml-model/src/DA/Finance/Instrument/Entitlement.daml"
                  "daml-model/src/DA/Finance/RefData/Fixing.daml"
...
DAML_TRIGGER_FILES=("daml-trigger/src/DA/Trigger/Finance/Asset/Lifecycle.daml"
                    ...
                    "daml-trigger/src/DA/Trigger/Finance/Instrument/Equity/Stock.daml"
                    "daml-trigger/src/DA/Trigger/Finance/Instrument/Equity/Option.daml"
